    ...
    <div class="boxed_wrapper">
      ...
      <!-- Page Title -->
        <section class="page-title p_relative centred">
            <div class="bg-layer p_absolute l_0 parallax_none parallax-bg" data-parallax='{"y": 100}' style="background-image: url(${imagepath}background/page-title-5.jpg);"></div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="blog-details-content p_relative d_block mr_20">
                            <div class="blog-post p_relative d_block mb_60">
                                <div class="content-one p_relative d_block mb_60">
                                    <div class="post-title p_relative d_block mb_60">
                                        ...
                                        <h2 class="d_block fs_40 lh_50 fw_bold mb_7">The Best Remote UX and UI Design Conferences</h2>
                                    ...
                                    <figure class="image-box p_relative d_block b_radius_5 mb_65"><img src="${imagepath}news/news-55.jpg" alt=""></figure>
                                    <div class="text">
                                    ...
                                    <div class="image-box p_relative d_block mb_65">
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                                <figure class="image p_relative d_block b_radius_5"><img src="${imagepath}news/news-56.jpg" alt=""></figure>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                                <figure class="image p_relative d_block b_radius_5"><img src="${imagepath}news/news-57.jpg" alt=""></figure>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text">
                                        ...
                                        <blockquote class="p_relative d_block pt_30 pr_150 pb_30 pl_40 b_radius_5 b_shadow_6 m_0">
                            ...
                            <div class="author-box p_relative d_block pt_45 pr_30 pb_40 pl_170 mb_60">
                                <figure class="author-thumb p_absolute l_40 t_40 w_100 h_100 b_radius_50"><img src="${imagepath}news/author-1.jpg" alt=""></figure>
                        ...
                        <div class="blog-sidebar p_relative d_block ml_20 b_shadow_6 b_radius_10">
                            <div class="sidebar-widget search-widget p_relative d_block pt_35 pr_40 pb_30 pl_40 b_radius_10">
                                ...
                                <div class="search-inner">
                                    <form action="https://html.tonatheme.com/2023/atrix/blog.html" method="post" class="search-form">
                            ...
                            <div class="sidebar-widget post-widget p_relative d_block pt_35 pr_40 pb_10 pl_40 b_radius_10">
                                ...
                                <div class="post-inner">
                                    <div class="post p_relative d_block pl_100 pb_20 mb_16">
                                        <figure class="post-thumb p_absolute l_0 t_4 w_80 h_80 b_radius_5"><a href="blog-details.html"><img src="${imagepath}news/post-1.jpg" alt=""></a></figure>
                                    ...
                                    <div class="post p_relative d_block pl_100 pb_20 mb_16">
                                        <figure class="post-thumb p_absolute l_0 t_4 w_80 h_80 b_radius_5"><a href="blog-details.html"><img src="${imagepath}news/post-2.jpg" alt=""></a></figure>
                                    ...
                                    <div class="post p_relative d_block pl_100 pb_20">
                                        <figure class="post-thumb p_absolute l_0 t_4 w_80 h_80 b_radius_5"><a href="blog-details.html"><img src="${imagepath}news/post-3.jpg" alt=""></a></figure>
