    ...
    <div class="boxed_wrapper">
       ...
       <%@include file="header.jsp"%>
        ...
        <section class="page-title about-page-3 p_relative centred">
            <div class="bg-layer p_absolute l_0 parallax_none parallax-bg" data-parallax='{"y": 100}' style="background-image: url(${imagepath}background/page-title-2.jpg);"></div>
            <div class="auto-container">
                <div class="content-box">
                    <h1 class="d_block fs_60 lh_70 fw_bold mb_10">About Us Modern</h1>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_21">
                            <div data-animation-box class="image-box p_relative d_block pb_140 mr_30">
                                <div class="shape">
                                    <div class="shape-1 p_absolute b_80 rotate-me" style="background-image: url(${imagepath}shape/shape-176.png);"></div>
                                    <div class="shape-2 t_100 p_absolute rotate-me" style="background-image: url(${imagepath}shape/shape-176.png);"></div>
                                </div>
                                <figure data-animation-text class="overlay-anim-black-bg image image-1 p_relative d_block paroller" data-animation="overlay-animation"><img src="${imagepath}resource/about-13.jpg" alt=""></figure>
                                <figure data-animation-text class="overlay-anim-black-bg image image-2 p_absolute r_0 b_0 paroller-2" data-animation="overlay-animation"><img src="${imagepath}resource/about-14.jpg" alt=""></figure>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="feature-block-eight wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pt_50 pr_30 pb_45 pl_30">
                                <div class="icon-box p_relative d_iblock mb_25">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-108.png" alt=""></div>
                                </div>
                                <div class="text">
                        ...
                        <div class="feature-block-eight wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pt_50 pr_30 pb_45 pl_30">
                                <div class="icon-box p_relative d_iblock mb_25">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-109.png" alt=""></div>
                                </div>
                                <div class="text">
                        ...
                        <div class="feature-block-eight wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pt_50 pr_30 pb_45 pl_30">
                                <div class="icon-box p_relative d_iblock mb_25">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-110.png" alt=""></div>
                                </div>
                                <div class="text">
                        ...
                        <div class="feature-block-eight wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pt_50 pr_30 pb_45 pl_30">
                                <div class="icon-box p_relative d_iblock mb_25">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-111.png" alt=""></div>
                                </div>
                                <div class="text">
        ...
        <section class="team-ten about-page-3 p_relative sec-pad centred">
            <div class="shape">
                <div class="shape-1 p_absolute t_120 r_150 rotate-me" style="background-image: url(${imagepath}shape/shape-176.png);"></div>
                <div class="shape-2 p_absolute l_140 float-bob-y" style="background-image: url(${imagepath}shape/shape-56.png);"></div>
                <div class="shape-3 p_absolute t_0 r_0" style="background-image: url(${imagepath}shape/shape-181.png);"></div>
            </div>
            <div class="auto-container">
                ...
                <div class="row clearfix">
                        ...
                        <div class="team-block-four wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block">
                                <div class="image-box p_relative d_block">
                                    <figure class="image p_relative d_block b_radius_50"><img src="${imagepath}team/team-30.jpg" alt=""></figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-four wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block">
                                <div class="image-box p_relative d_block">
                                    <figure class="image p_relative d_block b_radius_50"><img src="${imagepath}team/team-31.jpg" alt=""></figure>
                                    <ul class="social-links p_absolute l_0 t_0 clearfix tran_5">
                                        <li class="p_relative d_iblock"><a href="about-3.html" class="p_relative d_iblock fs_17 w_45 h_45 lh_45 centred b_radius_50 color_black"><i class="fab fa-facebook-f"></i></a></li>
                                        <li class="p_relative d_iblock"><a href="about-3.html" class="p_relative d_iblock fs_17 w_45 h_45 lh_45 centred b_radius_50 color_black"><i class="fab fa-twitter"></i></a></li>
                                        <li class="p_relative d_iblock"><a href="about-3.html" class="p_relative d_iblock fs_17 w_45 h_45 lh_45 centred b_radius_50 color_black"><i class="fab fa-linkedin-in"></i></a></li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-four wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block">
                                <div class="image-box p_relative d_block">
                                    <figure class="image p_relative d_block b_radius_50"><img src="${imagepath}team/team-32.jpg" alt=""></figure>
                                    <ul class="social-links p_absolute l_0 t_0 clearfix tran_5">
                                        <li class="p_relative d_iblock"><a href="about-3.html" class="p_relative d_iblock fs_17 w_45 h_45 lh_45 centred b_radius_50 color_black"><i class="fab fa-facebook-f"></i></a></li>
                                        <li class="p_relative d_iblock"><a href="about-3.html" class="p_relative d_iblock fs_17 w_45 h_45 lh_45 centred b_radius_50 color_black"><i class="fab fa-twitter"></i></a></li>
                                        <li class="p_relative d_iblock"><a href="about-3.html" class="p_relative d_iblock fs_17 w_45 h_45 lh_45 centred b_radius_50 color_black"><i class="fab fa-linkedin-in"></i></a></li>
        ...
        <section class="funfact-nine pt_85 pb_75 text-center p_relative">
            <div class="shape">
                <div class="shape-1 p_absolute l_120 float-bob-x" style="background-image: url(${imagepath}shape/shape-182.png);"></div>
                <div class="shape-2 p_absolute r_100 float-bob-x" style="background-image: url(${imagepath}shape/shape-183.png);"></div>
            </div>
            <div class="auto-container">
                <div class="row clearfix">
                        ...
                        <div class="counter-block-one wow slideInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block">
                                <div class="icon-box p_relative d_block fs_60 lh_60 tran_5 mb_15">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-112.png" alt=""></div>
                                </div>
                        ...
                        <div class="counter-block-one wow slideInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block">
                                <div class="icon-box p_relative d_block fs_60 lh_60 tran_5 mb_15">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-113.png" alt=""></div>
                                </div>
                                <div class="count-outer count-box p_relative d_block fs_60 lh_70 fw_bold mb_12 font_family_inter">
                        ...
                        <div class="counter-block-one wow slideInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block">
                                <div class="icon-box p_relative d_block fs_60 lh_60 tran_5 mb_15">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-114.png" alt=""></div>
                                </div>
                                <div class="count-outer count-box p_relative d_block fs_60 lh_70 fw_bold mb_12 font_family_inter">
                        ...
                        <div class="counter-block-one wow slideInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block">
                                <div class="icon-box p_relative d_block fs_60 lh_60 tran_5 mb_15">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-115.png" alt=""></div>
                                </div>
                                <div class="count-outer count-box p_relative d_block fs_60 lh_70 fw_bold mb_12 font_family_inter">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_22">
                            <div data-animation-box class="image-box p_relative d_block ml_30 pt_160 pr_190">
                                <div class="shape">
                                    <div class="shape-1 p_absolute t_90 rotate-me" style="background-image: url(${imagepath}shape/shape-176.png);"></div>
                                    <div class="shape-2 p_absolute b_80 float-bob-y" style="background-image: url(${imagepath}shape/shape-184.png);"></div>
                                </div>
                                <figure data-animation-text class="overlay-anim-black-bg image image-1 p_relative d_block z_1 paroller" data-animation="overlay-animation"><img src="${imagepath}resource/chooseus-7.jpg" alt=""></figure>
                                <figure data-animation-text class="overlay-anim-black-bg image image-2 p_absolute t_0 r_0 paroller-2" data-animation="overlay-animation"><img src="${imagepath}resource/chooseus-8.jpg" alt=""></figure>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- testimonial-five -->
        <section class="testimonial-five about-page-3 p_relative pb_140 pt_140 bg-color-1">
            <div class="shape">
                <div class="shape-1 p_absolute rotate-me" style="background-image: url(${imagepath}shape/shape-176.png);"></div>
                <div class="shape-2 p_absolute b_180 float-bob-y" style="background-image: url(${imagepath}shape/shape-185.png);"></div>
            </div>
            <div class="auto-container">
                <div class="sec-title-13 p_relative d_block mb_50 centred">
                    <h5 class="p_relative d_iblock fs_17 lh_30 fw_sbold mb_16 uppercase">Testimonials</h5>
                    <h2 class="d_block fs_40 fw_bold lh_50">Trusted by More Than 3k Clients <br />Around The World</h2>
                </div>
                <div class="three-item-carousel owl-carousel owl-theme dots-style-one owl-nav-none overflow_visible">
                    <div class="testimonial-block-one">
                        <div class="inner-box p_relative d_block b_radius_10 pt_40 pr_30 pb_35 pl_40">
                            <div class="quote p_absolute r_40 b_30 fs_50 lh_50 z_1">
                                <div class="icon"><i class="icon-176"></i></div>
                                <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-116.png" alt=""></div>
                            </div>
                            <div class="author p_relative d_block pl_90 pt_7 pb_11 mb_25">
                            ...
                            <div class="text p_relative d_block">
                                <p class="font_family_poppins mb_17">Lorem ipsum dolor amet consectur elit adicing elit sed do umod tempor incididunt enim ad minim veniam quis nostrud exer citation.</p>
                                <ul class="rating clearfix p_relative d_block">
                    ...
                    <div class="testimonial-block-one">
                        <div class="inner-box p_relative d_block b_radius_10 pt_40 pr_30 pb_35 pl_40">
                            ...
                            <div class="author p_relative d_block pl_90 pt_7 pb_11 mb_25">
                                ...
                                <h4 class="d_block fs_20 lh_30 mb_2">James Jhon</h4>
                                <span class="designation p_relative d_block fs_16 lh_20">Designer</span>
                            </div>
                            <div class="text p_relative d_block">
                                <p class="font_family_poppins mb_17">Lorem ipsum dolor amet consectur elit adicing elit sed do umod tempor incididunt enim ad minim veniam quis nostrud exer citation.</p>
