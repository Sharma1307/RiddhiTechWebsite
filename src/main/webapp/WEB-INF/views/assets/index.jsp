       ...
       <%@include file="header.jsp"%>
            ...
            <div class="banner-carousel owl-theme owl-carousel owl-dots-none">
                <div class="slide-item p_relative pt_140 pb_170">
                    <div class="shape-layer">
                        <div class="shape-1 p_absolute l_0 z_1" style="background-image: url(${imagepath}shape/shape-2.png);"></div>
                        <div class="shape-2 p_absolute l_0 t_0 z_1" style="background-image: url(${imagepath}shape/shape-3.png);"></div>
                        <div class="shape-3 p_absolute r_0 b_0 z_1" style="background-image: url(${imagepath}shape/shape-4.png);"></div>
                        <div class="shape-4 p_absolute r_0 b_0 z_1" style="background-image: url(${imagepath}shape/shape-5.png);"></div>
                    </div>
                    <div class="image-layer p_absolute" style="background-image:url(${imagepath}banner/banner-1.jpg)"></div>
                ...
                <div class="slide-item p_relative pt_140 pb_170">
                    ...
                    <div class="image-layer p_absolute" style="background-image:url(${imagepath}banner/banner-2.jpg)"></div>
                    <div class="auto-container">
                        <div class="content-box p_relative d_block z_5">
                            <h2 class="p_relative d_iblock fw_bold fs_80 lh_70 mb_25"><span class="slider-text-anim">Make Your Business with</span><br /> <span class="slider-text-anim">Unique Ideas.</span></h2>
                            <p class="d_block fs_18 mb_45">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia <br />deserunt mollit anim id est laborum.</p>
                ...
                <div class="slide-item p_relative pt_140 pb_170">
                    ...
                    <div class="image-layer p_absolute" style="background-image:url(${imagepath}banner/banner-3.jpg)"></div>
                    <div class="auto-container">
                        <div class="content-box p_relative d_block z_5">
                            <h2 class="p_relative d_iblock fw_bold fs_80 lh_70 mb_25"><span class="slider-text-anim">Make Your Business with</span><br /> <span class="slider-text-anim">Unique Ideas.</span></h2>
                            <p class="d_block fs_18 mb_45">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia <br />deserunt mollit anim id est laborum.</p>
                        ...
                        <div class="feature-block-one wow fadeInUp" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_100 pr_50 pt_11 pb_9">
                                <div class="icon-box p_absolute l_0 t_0 w_80 h_80 lh_80 b_radius_50 text-center fs_45 z_1">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-6.png" alt=""></div>
                                </div>
                        ...
                        <div class="feature-block-one wow fadeInUp" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_100 pr_70 pt_11 pb_9">
                                <div class="icon-box p_absolute l_0 t_0 w_80 h_80 lh_80 b_radius_50 text-center fs_45 z_1">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-7.png" alt=""></div>
                                </div>
                        ...
                        <div class="feature-block-one wow fadeInUp" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_100 pr_50 pt_11 pb_9">
                                <div class="icon-box p_absolute l_0 t_0 w_80 h_80 lh_80 b_radius_50 text-center fs_45 z_1">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-8.png" alt=""></div>
                                </div>
        ...
        <section class="about-one p_relative">
            <div class="pattern-layer parallax-scene parallax-scene-2">
                ...
                <div data-depth="0.50" class="pattern-2 p_absolute w_80 h_80" style="background-image: url(${imagepath}shape/shape-7.png);"></div>
            </div>
            <div class="auto-container">
                            ...
                            <div class="image_block_one">
                                <div data-animation-box class="image-box p_relative d_block mr_30 pb_100 pt_130">
                                    <div class="shape parallax-scene parallax-scene-1">
                                        <div data-depth="0.40" class="shape-1 p_absolute w_95 h_95" style="background-image: url(${imagepath}shape/shape-6.png);"></div>
                                        <div data-depth="0.50" class="shape-2 p_absolute w_95 h_95" style="background-image: url(${imagepath}shape/shape-6.png);"></div>
                                    </div>
                                    <figure data-animation-text class="overlay-anim-black-bg image image-1 p_relative d_block b_radius_10" data-animation="overlay-animation"><img src="${imagepath}resource/about-1.jpg" alt=""></figure>
                                    <div class="video-inner p_absolute r_140 b_0 pt_60 pb_60 text-center b_radius_10 w_200 z_2" style="background-image: url(${imagepath}resource/about-2.jpg);">
                                        <div class="video-btn">
        ...
        <section class="service-one p_relative sec-pad">
            <div class="pattern-layer">
                <div class="pattern-1 p_absolute t_0" data-parallax='{"x": 100}' style="background-image: url(${imagepath}shape/shape-9.png);"></div>
                <div class="pattern-2 p_absolute t_0" data-parallax='{"x": 100}' style="background-image: url(${imagepath}shape/shape-10.png);"></div>
                <div class="pattern-3 p_absolute b_0" data-parallax='{"x": 100}' style="background-image: url(${imagepath}shape/shape-11.png);"></div>
                <div class="pattern-4 p_absolute b_0" data-parallax='{"x": 100}' style="background-image: url(${imagepath}shape/shape-12.png);"></div>
            </div>
            <div class="auto-container">
                        ...
                        <div class="service-block-one wow slideInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                                <div class="icon-box p_relative d_iblock mb_30">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-2.png" alt=""></div>
                        ...
                        <div class="service-block-one wow slideInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                                <div class="icon-box p_relative d_iblock mb_30">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-3.png" alt=""></div>
                                    <div class="icon-shape hero-shape-four p_absolute w_90 h_70"></div>
                                </div>
                        ...
                        <div class="service-block-one wow slideInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                                <div class="icon-box p_relative d_iblock mb_30">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-4.png" alt=""></div>
                                    <div class="icon-shape hero-shape-four p_absolute w_90 h_70"></div>
                                </div>
                        ...
                        <div class="service-block-one wow slideInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                                <div class="icon-box p_relative d_iblock mb_30">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-5.png" alt=""></div>
                                    <div class="icon-shape hero-shape-four p_absolute w_90 h_70"></div>
                                </div>
        ...
        <section class="video-one p_relative pt_140 pb_150">
            <div class="bg-layer p_absolute l_0 parallax_none parallax-bg" data-parallax='{"y": 100}' style="background-image: url(${imagepath}background/video-bg.jpg);"></div>
            <div class="pattern-layer">
                <div class="pattern-1 p_absolute hero-shape-two l_0 b_0 z_1" style="background-image: url(${imagepath}shape/shape-13.png);"></div>
                <div class="pattern-2 p_absolute l_0 b_0 z_1" style="background-image: url(${imagepath}shape/shape-14.png);"></div>
                <div class="pattern-3 p_absolute hero-shape z_1" style="background-image: url(${imagepath}shape/shape-15.png);"></div>
                <div class="pattern-4 p_absolute t_0 r_0 z_1" style="background-image: url(${imagepath}shape/shape-16.png);"></div>
            </div>
            <div class="auto-container">
                                    ...
                                    <div class="inner-box p_relative d_block wow fadeInUp" data-wow-duration="1500ms">
                                        <div class="single-item p_relative d_block pl_80 mb_16">
                                            <div class="icon-box p_absolute l_0 t_3 w_50 h_50 lh_50 text-center b_radius_50 b_shadow_7">
                                                ...
                                                <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-1.png" alt=""></div>
                                            </div>
                            ...
                            <div class="image_block_two">
                                <div data-animation-box class="image-box p_relative d_block ml_30 pb_140 mt_20">
                                    <div class="shape parallax-scene parallax-scene-3">
                                        <div data-depth="0.40" class="shape-1 p_absolute w_150 h_150 z_2" style="background-image: url(${imagepath}shape/shape-17.png);"></div>
                                        <div data-depth="0.50" class="shape-2 p_absolute w_95 h_95" style="background-image: url(${imagepath}shape/shape-18.png);"></div>
                                        <div data-depth="0.30" class="shape-3 p_absolute w_95 h_95" style="background-image: url(${imagepath}shape/shape-18.png);"></div>
                                    </div>
                                    <figure data-animation-text class="overlay-anim-black-bg image image-1 p_relative d_block b_radius_10" data-animation="overlay-animation"><img src="${imagepath}resource/chooseus-1.jpg" alt=""></figure>
                                    <figure data-animation-text class="overlay-anim-black-bg image image-2 p_absolute l_0 b_0 b_radius_10 d_block" data-animation="overlay-animation"><img src="${imagepath}resource/chooseus-2.jpg" alt=""></figure>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="process-one p_relative sec-pad text-center bg-color-1">
            <div class="pattern-layer">
                <div class="pattern-1 p_absolute t_0" data-parallax='{"x": 100}' style="background-image: url(${imagepath}shape/shape-9.png);"></div>
                <div class="pattern-2 p_absolute t_0" data-parallax='{"x": 100}' style="background-image: url(${imagepath}shape/shape-10.png);"></div>
                <div class="pattern-3 p_absolute r_0 b_0" data-parallax='{"x": 100}' style="background-image: url(${imagepath}shape/shape-11.png);"></div>
                <div class="pattern-4 p_absolute r_0 b_0" data-parallax='{"x": 100}' style="background-image: url(${imagepath}shape/shape-12.png);"></div>
            </div>
            <div class="auto-container">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                        <div class="processing-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block">
                                <div class="shape p_absolute" style="background-image: url(${imagepath}shape/shape-19.png);"></div>
                                <div class="icon-box p_relative d_iblock w_170 h_170 lh_170 tran_5 b_radius_50 mb_30 z_1">
                                    ...
                                    <div class="icon-img hidden-icon"><img src="${imagepath}icons/hid-icon-9.png" alt=""></div>
                            ...
                            <div class="image_block_three">
                                <div data-animation-box class="image-box p_relative d_block mr_30 pr_190 pt_90">
                                    <div class="shape parallax-scene parallax-scene-4">
                                        <div data-depth="0.50" class="shape-1 p_absolute w_65 h_65" style="background-image: url(${imagepath}shape/shape-20.png);"></div>
                                        <div data-depth="0.30" class="shape-2 p_absolute w_95 h_95" style="background-image: url(${imagepath}shape/shape-18.png);"></div>
                                    </div>
                                    <figure data-animation-text class="overlay-anim-black-bg image image-2 p_absolute t_0 r_0 b_radius_10" data-animation="overlay-animation"><img src="${imagepath}resource/skills-2.jpg" alt=""></figure>
                                    <figure data-animation-text class="overlay-anim-black-bg image image-1 p_relative d_block b_radius_10" data-animation="overlay-animation"><img src="${imagepath}resource/skills-1.jpg" alt=""></figure>
                ...
                <div class="inner-container p_relative">
                    ...
                    <div class="five-item-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                        <div class="clients-logo-box">
                            <figure class="image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-1.png" alt=""></a></figure>
                            <figure class="overlay-image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-1.png" alt=""></a></figure>
                        </div>
                        <div class="clients-logo-box">
                            <figure class="image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-2.png" alt=""></a></figure>
                            <figure class="overlay-image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-2.png" alt=""></a></figure>
                        </div>
                        <div class="clients-logo-box">
                            <figure class="image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-3.png" alt=""></a></figure>
                            <figure class="overlay-image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-3.png" alt=""></a></figure>
                        </div>
                        <div class="clients-logo-box">
                            <figure class="image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-4.png" alt=""></a></figure>
                            <figure class="overlay-image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-4.png" alt=""></a></figure>
                        </div>
                        <div class="clients-logo-box">
                            <figure class="image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-5.png" alt=""></a></figure>
                            <figure class="overlay-image"><a href="index-2.html"><img src="${imagepath}clients/clients-logo-5.png" alt=""></a></figure>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="three-item-carousel owl-carousel owl-theme owl-nav-none dots-style-one">
                        <div class="testimonial-block-one">
                            <div class="inner-box p_relative d_block">
                                ...
                                <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                                    <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="${imagepath}resource/testimonial-1.png" alt=""></figure>
                        ...
                        <div class="testimonial-block-one">
                            <div class="inner-box p_relative d_block">
                                ...
                                <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                                    <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="${imagepath}resource/testimonial-2.png" alt=""></figure>
                        ...
                        <div class="testimonial-block-one">
                            <div class="inner-box p_relative d_block">
                                ...
                                <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                                    <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="${imagepath}resource/testimonial-3.png" alt=""></figure>
        ...
        <section class="funfact-one pt_90 pb_80 text-center p_relative">
            <div class="shape parallax-scene parallax-scene-5">
                <div data-depth="0.50" class="shape-1 p_absolute" style="background-image: url(${imagepath}shape/shape-21.png);"></div>
                <div data-depth="0.30" class="shape-2 p_absolute" style="background-image: url(${imagepath}shape/shape-22.png);"></div>
            </div>
            <div class="auto-container">
                <div class="row clearfix">
                                        ...
                                        <div class="pricing-block-one">
                                            <div class="pricing-table p_relative d_block pt_45 pr_50 pb_50 pl_50 b_radius_10">
                                                ...
                                                <div class="table-footer">
                                                    <a href="index-2.html" class="theme-btn theme-btn-two"><span data-text="Select Plan">Select Plan</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 pricing-block">
                                        <div class="pricing-block-one active-block">
                                            <div class="pricing-table p_relative d_block pt_45 pr_50 pb_50 pl_50 b_radius_10">
                                                ...
                                                <div class="shape-2 p_absolute t_0 r_0" style="background-image: url(${imagepath}shape/shape-24.png);"></div>
                                                <div class="table-header p_relative d_block mb_30">
                                                ...
                                                <div class="table-footer">
                                                    <a href="index-2.html" class="theme-btn theme-btn-one">Select Plan<i class="icon-4"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section class="cta-one p_relative pt_130 pb_140 centred">
            <div class="bg-layer p_absolute l_0 parallax_none parallax-bg" data-parallax='{"y": 100}' style="background-image: url(${imagepath}background/cta-bg.jpg);"></div>
            <div class="shape">
                <div class="shape-1 hero-shape-three p_absolute z_1"></div>
                <div class="shape-2 p_absolute l_0 b_0 z_1" style="background-image: url(${imagepath}shape/shape-26.png);"></div>
                <div class="shape-3 hero-shape-three p_absolute z_1"></div>
                <div class="shape-4 p_absolute t_0 r_0 z_1" style="background-image: url(${imagepath}shape/shape-16.png);"></div>
            </div>
            <div class="auto-container">
                <div class="inner-box p_relative z_1">
                    ...
                    <a href="index-2.html" class="theme-btn theme-btn-two wow slideInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms"><span data-text="Get Started">Get Started</span></a>
                </div>
            </div>
        </section>
        <!-- cta-one end -->
                    ...
                    <div class="row clearfix">
                            ...
                            <div class="news-block-one wow slideInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box p_relative d_block b_radius_10 b_shadow_6">
                                    <div class="image-box p_relative d_block">
                                        <figure class="image p_relative d_block"><a href="blog-details.html"><img src="${imagepath}news/news-1.jpg" alt=""></a></figure>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow slideInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="inner-box p_relative d_block b_radius_10 b_shadow_6">
                                    <div class="image-box p_relative d_block">
                                        <figure class="image p_relative d_block"><a href="blog-details.html"><img src="${imagepath}news/news-2.jpg" alt=""></a></figure>
                                        <div class="post-date p_absolute l_30 t_30 b_shadow_6 pt_1 pr_19 pb_1 pl_19 z_1">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow slideInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div class="inner-box p_relative d_block b_radius_10 b_shadow_6">
                                    <div class="image-box p_relative d_block">
                                        <figure class="image p_relative d_block"><a href="blog-details.html"><img src="${imagepath}news/news-3.jpg" alt=""></a></figure>
                                        <div class="post-date p_absolute l_30 t_30 b_shadow_6 pt_1 pr_19 pb_1 pl_19 z_1">
...
<!-- Mirrored from html.tonatheme.com/2023/atrix/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Nov 2024 06:35:16 GMT -->
</html>
